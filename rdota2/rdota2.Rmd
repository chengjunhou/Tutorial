...
比如预测概率从大到小排列为(0.92, 0.87, 0.76, 0.68, 0.67, 0.64, 0.55, 0.43, 0.39)，真实值为(1, 1, 1, 1, 0, 0, 1, 0, 0, 0), ROC 曲线为：

```{r, message=FALSE, warning=FALSE}
library(ROCR)
roc_obj <- prediction(c(0.92, 0.87, 0.76, 0.68, 0.67, 0.64, 0.55, 0.43, 0.39), 
