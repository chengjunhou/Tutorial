...
试验用数据"LogisticExample.RData"里储存了$100 \times 30$的矩阵$x$，和元素是0/1长度是100的向量$y$，[下载链接](https://github.com/chengjunhou/Tutorial/blob/master/LASSO/LogisticExample.RData):
