...
这篇文章主要介绍LASSO回归，所以我们集中关注 $\alpha=1$ 的情况，
对于另外两种模型的特点和如何选取最优 $\alpha$ 值，我会在[第四节](#elnet)做一些简单阐述。 
...
然后通过一个保险行业的实例，分享一些实际建模过程中的经验，包括如何选取和预处理数据，
如何直观得分析自变量与因变量之间的关系，如何避免过度拟合，如何衡量和选取最终模型。
